...
function clearRoute(e) {
    ...
    <p>В правом верхнем углу задайте тип маршрута. Далее начните добавлять точки кликом по карте. В всплывшем окошке выберите скорость и нажмите "Добавить точку"</p> \
    <p>После добавления всех точек(не более 10) нажмите "Проложить маршрут"</p> \
